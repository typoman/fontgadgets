...
def flattenedCopy(glyph):
    ...
    glyph.clear(contours=True, components=False, anchors=False, guidelines=False, image=False)
...
class ShapeDataPen(AbstractPointPen):
    ...
    shape data inside the glyph (minus the glyph.width).
    """
